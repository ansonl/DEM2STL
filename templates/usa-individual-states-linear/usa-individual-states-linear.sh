...
# cd .\development\dem-to-stl-workflow\template-workspace\usa-individual-states-linear\250
...
#gdal
python ./generate-batch.py .\templates\usa-individual-states-linear\usa-individual-states-linear.json -gc

#tt
python ./generate-batch.py .\templates\usa-individual-states-linear\usa-individual-states-linear.json -gt