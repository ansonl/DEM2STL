...
echo RI result $?
echo 9 Mesh boolean subtracting VI
...
echo VI result $?
echo 12 Mesh boolean subtracting DE
...
echo DE result $?
echo 15 Mesh boolean subtracting CT
...
echo CT result $?
echo 18 Mesh boolean subtracting NJ
...
echo NJ result $?
echo 21 Mesh boolean subtracting PR
...
echo PR result $?
echo 24 Mesh boolean subtracting VT
...
echo VT result $?
echo 27 Mesh boolean subtracting NH
...
echo NH result $?
echo 30 Mesh boolean subtracting MA
...
echo MA result $?
echo 33 Mesh boolean subtracting MD
...
echo MD result $?
echo 36 Mesh boolean subtracting IN
...
echo IN result $?
echo 39 Mesh boolean subtracting WV
...
echo WV result $?
echo 42 Mesh boolean subtracting SC
...
echo SC result $?
echo 45 Mesh boolean subtracting OH
...
echo OH result $?
echo 48 Mesh boolean subtracting PA
...
echo PA result $?
echo 51 Mesh boolean subtracting ME
...
echo ME result $?
echo 54 Mesh boolean subtracting MS
...
echo MS result $?
echo 57 Mesh boolean subtracting AR
...
echo AR result $?
echo 60 Mesh boolean subtracting IA
...
echo IA result $?
echo 63 Mesh boolean subtracting AL
...
echo AL result $?
echo 66 Mesh boolean subtracting TN
...
echo TN result $?
echo 69 Mesh boolean subtracting MP
time ./tools/gp-cli/precompiled/pc/bin/meshboolean.exe ./state_stls_250m/MP-no-rivers/MP_tile_1_1.STL ./state_stls_250m/MP/MP_tile_1_1.STL minus ./state_stls_250m/MP/MP_rivers.STL
echo MP result $?
echo 72 Mesh boolean subtracting ND
...
echo ND result $?
echo 75 Mesh boolean subtracting KY
...
echo KY result $?
echo 78 Mesh boolean subtracting IL
...
echo IL result $?
echo 81 Mesh boolean subtracting KS
...
echo KS result $?
echo 84 Mesh boolean subtracting LA
...
echo LA result $?
echo 87 Mesh boolean subtracting GA
...
echo GA result $?
echo 90 Mesh boolean subtracting SD
...
echo SD result $?
echo 93 Mesh boolean subtracting NE
...
echo NE result $?
echo 96 Mesh boolean subtracting WA
...
echo WA result $?
echo 99 Mesh boolean subtracting NC
...
echo NC result $?
echo 102 Mesh boolean subtracting VA
...
echo VA result $?
echo 105 Mesh boolean subtracting WI
...
echo WI result $?
echo 108 Mesh boolean subtracting MO
...
echo MO result $?
echo 111 Mesh boolean subtracting OK
...
echo OK result $?
echo 114 Mesh boolean subtracting UT
...
echo UT result $?
echo 117 Mesh boolean subtracting WY
...
echo WY result $?
echo 120 Mesh boolean subtracting CO
...
echo CO result $?
echo 123 Mesh boolean subtracting NY
...
echo NY result $?
echo 126 Mesh boolean subtracting MN
...
echo MN result $?
echo 129 Mesh boolean subtracting NM
...
echo NM result $?
echo 132 Mesh boolean subtracting AZ
...
echo AZ result $?
echo 135 Mesh boolean subtracting OR
...
echo OR result $?
echo 138 Mesh boolean subtracting ID
...
echo ID result $?
echo 141 Mesh boolean subtracting NV
...
echo NV result $?
echo 144 Mesh boolean subtracting MI
...
echo MI result $?
echo 147 Mesh boolean subtracting MT
...
echo MT result $?
echo 150 Mesh boolean subtracting FL
...
echo FL result $?
echo 153 Mesh boolean subtracting CA
...
echo CA result $?
echo 156 Mesh boolean subtracting TX
