...
gdalbuildvrt -resolution highest -overwrite north_america_hydrographic_mask_merge.vrt coastline_hydrographic_mask_merge_int16.vrt hydro1k_mask_buffer1k_wgs84.tif hydrolakes_mask_gt10sqkm_wgs84.tif
